...
<Diagram name="career-pivot-navigator-plan" />
...
<h2 id="overview" class="scroll-mt-32">How it is built</h2>

<figure class="not-prose my-10">
<Diagram name="career-pivot-navigator-architecture" />
...
<h2 id="decision" class="scroll-mt-32">The decision the build made</h2>
...
<h2 id="guardrails" class="scroll-mt-32">Responsible by design</h2>
