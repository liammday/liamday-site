...
<figure class="not-prose my-10">
  <picture>
    <source srcset="/assets/images/projects/open-defence-radar-console.webp" type="image/webp">
    <img src="/assets/images/projects/open-defence-radar-console.png" alt="The web console answering a question about UK defence contracts mentioning AI or autonomy, with inline citation chips, a groundedness read of 1.00, and a numbered list of sources." width="1600" height="2170" loading="lazy" class="w-full rounded-2xl border border-aluminum-500/20">
  </picture>
...
<figure class="not-prose my-10">
<Diagram name="open-defence-radar-architecture" />
...
<h2 id="grounding" class="scroll-mt-32">How it stays grounded</h2>
...
<figure class="not-prose my-10">
  <picture>
    <source srcset="/assets/images/projects/open-defence-radar-trust.webp" type="image/webp">
    <img src="/assets/images/projects/open-defence-radar-trust.png" alt="The trust dashboard: retrieval hit-rate 1.00, groundedness 0.95, unsupported-claim rate 0.05, a provenance table of the three ingested sources, and a region-level choropleth of procurement activity." width="1600" height="1874" loading="lazy" class="w-full rounded-2xl border border-aluminum-500/20">
  </picture>
...
<h2 id="failure" class="scroll-mt-32">A decision the eval made</h2>
...
<h2 id="guardrails" class="scroll-mt-32">Clearance-safe by design</h2>
