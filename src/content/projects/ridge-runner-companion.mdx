...
image: /assets/images/projects/ridge-runner-companion-og-card.png
type: App build
...
<h2 id="direction" class="scroll-mt-32">Product direction</h2>
...
<h2 id="build-focus" class="scroll-mt-32">Build focus</h2>
